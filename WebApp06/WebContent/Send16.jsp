...
<style type="text/css">
.txt{width: 50px; }
select{margin: 15px 0; text-align: center; width: 60px;}
...
<!--  	- 정수1 / 정수2 / 연산자 -->
<!--  	- http://localhost:3306/WebApp06/Send16.jsp -->

<!--  ② 연산 전용 페이지 구성 -->
<!--  	- response.sendRedirect()를 포함한 스크립릿 코드만 존재 -->
<!--  	  → 추후 우리는 이 코드를 JAVA로 분리하여 → Servlet으로 구성할 예정 -->
<!--  	- http://localhost:3306/WebApp06/Redirect16.jsp -->

<!--  ③ 최종 결과 출력 페이지 구성 -->
<!--  	- 연산 전용 페이지에서 처리한 결과를 넘겨받아 클라이언트와 대면할 페이지로 구성 -->
<!--  	  → 추후 우리는 이 페이지를 JSP View 페이지 역할을 수행하도록 구성할 예정 --->
<!--  	- http://localhost:3306/WebApp06/Receive16.jsp  -->
<div>
	<form action="Redirect16.jsp" method="post">
