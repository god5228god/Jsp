...
VALUES(SCORESEQ.NEXTVAL, '양호열', 90, 80, 70);
--> 한줄 구성
INSERT INTO TBL_SCORE(SID, NAME, KOR, ENG, MAT) VALUES(SCORESEQ.NEXTVAL, '양호열', 90, 80, 70)
;
--==>> 1 행 이(가) 삽입되었습니다.
...
--○ 더미 데이터 추가 입력
INSERT INTO TBL_SCORE(SID, NAME, KOR, ENG, MAT) VALUES(SCORESEQ.NEXTVAL, '유현선', 80, 70, 60)
;
INSERT INTO TBL_SCORE(SID, NAME, KOR, ENG, MAT) VALUES(SCORESEQ.NEXTVAL, '윤주열', 70, 60, 50)
;
INSERT INTO TBL_SCORE(SID, NAME, KOR, ENG, MAT) VALUES(SCORESEQ.NEXTVAL, '이수빈', 50, 40, 30)
;
--==>> 1 행 이(가) 삽입되었습니다. * 3
