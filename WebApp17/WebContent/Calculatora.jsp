...
<div>
	<!-- ① 첫 번째 방법  -->
	<!-- <form action="Calculator_ok1.jsp" method="post" name="myForm"> -->
	
	<!-- ② 두 번째 방법  -->
	<!-- <form action="Calculator_ok2.jsp" method="post" name="myForm"> -->
	
	<!-- ③ 세 번째 방법  -->
	 <form action="Calculator_ok3.jsp" method="post" name="myForm"> 
		<table class="table">
			<tr>
				<th>첫 번째 정수</th>
