...
<body>
	...
	<div>
		...
		<!-- ※ form 태그의 속성  -->
		<!-- 『action="/WebApp04/login"』 → 데이터를 전송하며 요청하는 페이지 -->
		<!-- (생략 시 데이터 전송 및 페이지 요청의 대상은 자기 자신) -->
		<!-- 『method="get"』			  → 데이터 전송 및 페이지 요청 방식 : get 방식 -->
		<!-- (생략 시 get 방식) -->
			...
			<table>
				<tr>
					...
					<td>
						...
						<input type="text" id="userId" class="txt" style="width: 100px;"
				...
				<tr>
					...
					<td>
						...
						<input type="password" id="userPwd" class="pwd" style="width: 100px;"
						name="userPwd"/>
					</td>
				</tr>
				<tr style="height: 50px">
					<td colspan="2" style="text-align: center;">
						...
						<!-- ※ 『submit』 액션 처리 →  form 데이터 전송 및 페이지 요청 -->
